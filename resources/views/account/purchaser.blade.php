...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
        <p class="page-indicate">Account/Purchaser</p>
        <div style="margin-top:10px;">
        <button id="filterButton" class="btn main-color">Filter</button>
        <button class="btn main-color"><a href="/purchaseraccounts" style="color: white; text-decoration:none;">Remove Filters</a></button>
        <button class="btn main-color"><i class="px-1 fa-solid fa-plus"></i><a href="/addpurchaseramount" style="color: white; text-decoration:none;">Add Amount</a></button>
        </div>
    </div>
    <div class="row my-2">
        @if(session('success'))
    ...
    <div id="filterContainer" class="conatiner-fluid" style="display: none;">
        <div class="row">
            <form class="custom-form mt-3"  action="{{ route('purchaseraccountfilter') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="purchaser" name="purchaser">
                                ...
                                @foreach ($purchasersfilters as $purchaser)
    ...
    <div class="row my-4">
        <div class="col-md-12">
                ...
                <table class="table table-hover">
                    <thead class="main-color">
                        <tr>
                            ...
                            <th scope="col">Pending Price to Receive</th>
                    ...
                    <tbody>
                        @foreach($purchasers as $index => $purchaser)
                            <tr>
                                ...
                                <td><a href="/purchaserreport/{{ $purchaser->name }}"><span style="background-color: #212529" class="badge">Current Month</span></i></a></td>
                                <td><a href="/purchaserlastreport/{{ $purchaser->name }}"><span style="background-color: #212529" class="badge">Last Month</span></i></a></td>
                                <td><a href="/purchaserdetail/{{ $purchaser->name }}"><span class="badge bg-primary">Transactions</span></a></td>
                            </tr>
                        @endforeach
            ...
            <div>
                {{ $purchasers->links('pagination::bootstrap-5') }}
            </div>
