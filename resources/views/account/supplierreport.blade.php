            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @if($yarnpurchases->count() > 0)
                                  
                                        @foreach($yarnpurchases as $index => $yarnsale)
                                        <tr>
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @if($fabricpurchases->count() > 0)
                              
                                        @foreach($fabricpurchases as $index => $fabricsale)
                                        <tr>
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="table-responsive ">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @if($purchasesuits->count() > 0)
                                        @foreach ($purchasesuits as $index=> $salesuit)
                                            <tr>
                                                <td>{{$index+1}}</td>
