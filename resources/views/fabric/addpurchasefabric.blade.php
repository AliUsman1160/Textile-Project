...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
        <p class="page-indicate">Fabric / Purchase / Add  </p>
    ...
    <form class="custom-form mt-5" action="{{ route('addfabricpurchase') }}" method="post">
        @csrf
        ...
        <div class="row my-4">
            <div class="col-lg-6 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="number" step="any" class="form-control @error('meter') is-invalid @enderror" id="meter" placeholder="10.0" name="meter" value="{{ old('meter') }}">
                    @error('meter')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row mt-3">
            <div class="col-12 d-flex justify-content-center">
                <button type="submit" class="btn main-color">Add Purchase Fabric Record</button>
            </div>
        </div>
    </form>
